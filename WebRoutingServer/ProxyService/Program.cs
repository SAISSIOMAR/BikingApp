...
namespace ProxyService
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8090/ISeriveProxy/ServiceProxy");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(ServiceProxy), httpUrl);
            ...
            Console.WriteLine("ServiceProxy is host at " + DateTime.Now.ToString());
